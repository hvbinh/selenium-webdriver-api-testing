...
public class Topic_09 {
	...
	public void TC_03_Default_CheckBox() {
		...
		// default
		WebElement duaZoneCheckbox = driver
		...
		if (!driver.findElement(By.xpath("//label[text()='2.0 Petrol, 147kW']/preceding-sibling::input"))
				.isSelected()) {
	...
	public void TC_04_custom_Checkbox_RadioButton() {
		...
		WebElement winter = driver.findElement(
				By.xpath("//label[@class='mat-radio-label']//div[contains(.,'Winter')]/preceding-sibling::div/input"));
